...
<div class="container py-5">
    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <a href="tampilInventaris.php" class="btn btn-outline-secondary rounded-pill me-2 px-3">
                ← Kembali ke Inventaris
            </a>
            <a href="tambahPeminjaman.php" class="btn btn-primary rounded-pill px-4 shadow-sm">
                + Catat Peminjaman
            </a>
        </div>
    </div>
    ...
    <div class="row g-4 mb-5">
        <div class="col-lg-8">
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="stat-card bg-green-gradient d-flex align-items-center justify-content-between">
                        <div class="position-relative z-1">
                            <h6 class="mb-1 opacity-75">Total Riwayat Pengembalian</h6>
                            <h2 class="fw-bold mb-0"><?= $dikembalikan ?> <span class="fs-6 fw-normal">Transaksi Selesai</span></h2>
                        </div>
                        <div class="icon-overlay" style="font-size: 3rem; bottom: -5px;">✅</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="chart-card d-flex flex-column align-items-center justify-content-center text-center">
                <h6 class="fw-bold text-muted mb-3">Persentase Status</h6>
                <div style="width: 200px; height: 200px;">
                    <canvas id="myChart"></canvas>
                </div>
                <p class="small text-muted mt-3">Visualisasi data peminjaman</p>
            </div>
        </div>
    </div>
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Jumlah Barang',
                data: [<?= $dipinjam ?>, <?= $dikembalikan ?>, <?= $terlambat ?>],
                backgroundColor: [
                    '#3b82f6', 
                    '#10b981', 
                    '#ef4444'  
